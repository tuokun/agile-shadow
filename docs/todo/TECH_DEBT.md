...
**文件**: `app/src/main/java/io/github/cgfhsc/agileshadow/ime/ui/keyboard/KeyboardViewModel.kt`
...
**文件**: `app/src/main/java/io/github/cgfhsc/agileshadow/ime/AgileShadowKeyboard.kt` 第 41-47 行
...
**文件**: `app/src/main/java/io/github/cgfhsc/agileshadow/ime/data/Prefs.kt`
...
- 键盘声音未实现
- `AgileShadowKeyboard` 暗色判断用 `isSystemInDarkTheme()`，未读取 `darkTheme`
- 默认键盘设置未被消费
...
**文件**: `app/src/main/java/io/github/cgfhsc/agileshadow/ime/ui/keyboard/KeyboardViewModel.kt` 第 54-146 行
...
**文件**: `app/src/main/java/io/github/cgfhsc/agileshadow/ime/ui/keyboard/HandwritingBoard.kt` 第 46 行
...
- `AgileShadowKeyboard` 用 `isSystemInDarkTheme()` 而非 Prefs 中的 `darkTheme` 设置
...
**文件**: `app/src/main/java/io/github/cgfhsc/agileshadow/ime/ui/keyboard/KeyboardViewModel.kt` 第 38 行
